  ...
  return (
    <div className={`inline-flex ${props.className}`}>
      <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M8 4L8 14" stroke="#D0CFD4" strokeWidth="2"/>
        <path d="M4.63605 10.8787L7.87873 14.1213L11.1214 10.8787M11.1214 7.1213L7.87873 3.87866L4.63605 7.1213" stroke="#D0CFD4" strokeWidth="2"/>
      </svg>
    </div>
  )
}
